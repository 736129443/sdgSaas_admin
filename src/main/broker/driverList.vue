 ...
 * @LastEditTime: 2019-08-13 09:59:13
 * @LastEditors: Please set LastEditors
 -->
<template>
  <div class="driverList common-content">
    <div>
...
export default {
  ...
  data() {
    return {
      positions: Window.getCurrentLocation("3-3"),
      buttonList: [
        {
          text: "新增",
          method: "new"
  ...
  methods: {
    ...
    apiListFetch() {
      let params = {
        ...
        userName: this.conditions.driverName || "",
        userPhone: this.conditions.driverPhone || ""
      };
